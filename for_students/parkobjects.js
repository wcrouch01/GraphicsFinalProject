...
export class GrSimpleRoundabout extends GrObject {
    ...
    constructor(params={}) {
		...
		this.tick = function(delta, timeOfDay) { this.platform.rotateY(0.005*delta); }
	}
}
...
export class GrAdvancedSwing extends GrObject {
    ...
    constructor(params={}, r) {
		...
		let dir = r ? Number(r) : 0;
	    this.whole_ob.rotateY(dir ? Number(dir) : 0);
...
export class GrCarousel extends GrObject {
	...
	tick()
	{
		this.whole_ob.rotateY(Math.PI/64);
	}
}